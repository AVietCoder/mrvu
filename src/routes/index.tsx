...
function Page() {
  ...
  // ⚡ Debounce: ô input vẫn cập nhật tức thì (gõ mượt), nhưng việc lọc/sắp xếp
  // lại trên TOÀN BỘ danh sách đơn chỉ chạy sau khi ngừng gõ 250ms → tránh
  // recompute nặng + re-render giật mỗi lần nhấn phím khi có hàng chục nghìn đơn.
  ...
  // ⚡ Memo hóa các mảng option cho dropdown trong form tạo đơn.
  // Trước đây các mảng này được .map() INLINE ngay trong JSX → bị dựng lại
  // toàn bộ (có thể hàng chục nghìn phần tử) trên MỖI lần render/gõ phím.
  // Memo hóa giúp chỉ dựng lại khi dữ liệu nguồn đổi. KHÔNG đổi nội dung hiển thị.
