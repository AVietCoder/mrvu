...
import { Plus, Pencil, Trash2, Search, Tags, ChevronLeft, ChevronRight } from "lucide-react";
    ...
    <AppShell title="Quản lý hàng hóa">
      <Card>
        <div className="flex items-center gap-3 mb-4">
          ...
          {/* Danh mục & Thương hiệu — chỉ admin */}
          {isAdmin && (
        ...
        {isLoading ? (
          ...
          <>
            <table className="w-full text-sm">
              <thead className="text-left text-muted-foreground border-b">
                <tr>
                  ...
                  <th className="pr-2">Nhóm hàng</th>
                    ...
                    <tr key={p.id} className="border-b last:border-0 hover:bg-muted/30">
                      ...
                      {isAdmin && (
                        <td className="text-right">
                          <Button size="icon" variant="ghost" onClick={() => startEdit(p.id)}>
            ...
            {/* Pagination — hiện khi > 20 sản phẩm */}
            {totalPages > 1 && (
