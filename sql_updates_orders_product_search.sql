-- ============================================================================
-- MIGRATION: Thêm tìm kiếm theo tên sản phẩm cho search_orders_page
-- Chạy 1 lần trong Supabase → SQL Editor.
-- Thêm: tìm kiếm theo tên sản phẩm trong đơn hàng (order_items JOIN products)
-- ============================================================================

DROP FUNCTION IF EXISTS public.search_orders_page(text, text, text, text, text[], text, text, date, date, text, integer, integer);
